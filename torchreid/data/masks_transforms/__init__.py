...
from .yolo_mask_transform import *
...
masks_preprocess_yolo = {
    'yolo_five_v': CombineYOLOIntoFiveVerticalParts,
}
...
masks_preprocess_transforms = {**masks_preprocess_pifpaf, **masks_preprocess_coco, **masks_preprocess_yolo}
masks_preprocess_all = {**masks_preprocess_pifpaf, **masks_preprocess_fixed, **masks_preprocess_coco, **masks_preprocess_yolo}
