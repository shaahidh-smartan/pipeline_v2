# modules/seated_db_shoulder_press.py
...
class Seated_DB_Shoulder_Press:
    def __init__(self):
    ...
    def analyze_batch(self, df, *,
                      exercise_name=None,
                      analyzer_used="Seated_DB_Shoulder_Press",
...
#   - Why it's bad: Reduces shoulder isolation, transfers stress to the lower back, and can risk injury.
#
